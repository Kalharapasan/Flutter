...
// HomeScreen is Stateful because we update UI dynamically
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Data returned from DetailScreen
  String returnedData = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Flutter Complete Example"),
      ...
      body: ListView(
        ...
        children: [
          ...
          // Stateless widget inside StatefulWidget
...
// Stateless Widget used inside Stateful Widget
class StaticTextWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Center(
      child: Text(
        "Welcome to Flutter Full Example!",
